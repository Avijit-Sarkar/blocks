...
function Banner() {
  return (
    <>
      <main className="flex items-center mt-10 text-white w-full min-h-screen dark:text-light">
        <div className="w-full h-full inline-block z-[4] bg-white/10 rounded-md dark:bg-black/40 p-8 xl:p-24 lg:p-16 md:p-12 sm:p-8">
